package inclass2a.com.example.inclass2a;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.ToFeet).setOnClickListener(this);
        findViewById(R.id.ToInches).setOnClickListener(this);

        findViewById(R.id.ToMiles).setOnClickListener(this);
